    ...
    Readability2.prototype = {
      ...
      _getArticleTitle() {
        ...
        if (/ [\|\-\\\/>»] /.test(curTitle)) {
          ...
          var match2 = this._someNode(headings, function(heading) {
      ...
      _grabArticle(page) {
        ...
        while (true) {
          ...
          this._forEachNode(elementsToScore, function(elementToScore) {
            ...
            var innerText3 = this._getInnerText(elementToScore);
            if (innerText3.length < 25) {
              return;
            }
            ...
            var contentScore = 0;
            contentScore += 1;
            contentScore += innerText3.split(this.REGEXPS.commas).length;
            contentScore += Math.min(Math.floor(innerText3.length / 100), 3);
      ...
      _getInnerText(e, normalizeSpaces) {
        ...
        var textContent3 = e.textContent.trim();
        if (normalizeSpaces) {
          return textContent3.replace(this.REGEXPS.normalize, " ");
        }
        return textContent3;
      },
      /**
      ...
      _cleanConditionally(e, tag) {
        ...
        this._removeNodes(this._getAllNodesWithTag(e, [tag]), function(node) {
          ...
          if (this._getCharCount(node, ",") < 10) {
            ...
            var innerText3 = this._getInnerText(node);
            if (this.REGEXPS.adWords.test(innerText3) || this.REGEXPS.loadingWords.test(innerText3)) {
              return true;
            }
            var contentLength = innerText3.length;
      ...
      parse() {
        ...
        var textContent3 = articleContent.textContent;
        return {
...
// node_modules/.pnpm/hono@4.13.3/node_modules/hono/dist/http-exception.js
...
var Hono = class _Hono {
  ...
  */
      ...
      for (const p of [path].flat()) {
        ...
        for (const m of [method].flat()) {
          handlers.map((handler4) => {
            this.#addRoute(m.toUpperCase(), this.#path, handler4);
          });
        }
      }
      return this;
  ...
  route(path, app2) {
    ...
    app2.routes.map((r) => {
      ...
      if (app2.errorHandler === errorHandler) {
        ...
        handler4 = async (c, next) => (await compose([], app2.errorHandler)(c, () => r.handler(c, next))).res;
  ...
  #addRoute(method, path, handler4, baseRoutePath) {
      ...
      Object.keys(middleware).forEach((m) => {
        if (method === METHOD_NAME_ALL || method === m) {
          Object.keys(middleware[m]).forEach((p) => {
            re.test(p) && middleware[m][p].push([handler4, paramCount]);
          });
        }
      });
      Object.keys(routes).forEach((m) => {
        if (method === METHOD_NAME_ALL || method === m) {
          Object.keys(routes[m]).forEach(
            (p) => re.test(p) && routes[m][p].push([handler4, paramCount])
          );
        }
      });
      return;
    ...
    for (let i = 0, len = paths.length; i < len; i++) {
      ...
      Object.keys(routes).forEach((m) => {
        if (method === METHOD_NAME_ALL || method === m) {
          ...
          routes[m][path2].push([handler4, paramCount - len + i + 1]);
        }
      });
    }
  }
...
var TrieRouter = class {
  ...
  add(method, path, handler4) {
    for (const result of checkOptionalParameter(path) || [path]) {
      this.#node.insert(method, result, handler4);
    }
  }
  match(method, path) {
...
// node_modules/.pnpm/hono@4.13.3/node_modules/hono/dist/utils/cookie.js
...
// node_modules/.pnpm/hono@4.13.3/node_modules/hono/dist/helper/cookie/index.js
...
// node_modules/.pnpm/hono@4.13.3/node_modules/hono/dist/validator/validator.js
      ...
      case "form": {
        ...
        formData.forEach((value2, key2) => {
          if (key2.endsWith("[]")) {
            ...
            ;
            form[key2].push(value2);
          } else if (Object.hasOwn(form, key2)) {
...
var Node4 = class extends DOMEventTarget {
...
var QUOTE = /"/g;
var Attr = class _Attr extends Node4 {
...
var CharacterData = class extends Node4 {
...
var isNode = (node) => node instanceof Node4;
...
var DocumentType = class _DocumentType extends Node4 {
...
setPrototypeOf(Node5, Node4);
Node5.prototype = Node4.prototype;
  ...
  async (c) => {
    ...
    const res = await fetch(url, {
      ...
      headers: {
        ...
        "User-Agent": "Mozilla/5.0 (compatible; web-reader; +https://github.com/akku1139/web-reader)",
